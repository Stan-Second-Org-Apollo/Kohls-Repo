...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|collection|string|The product collection at the time of order placed.||||||||
...
|sephoraBirthdayOffer|boolean|Customer hits order confirmation page and one of the products was a Sephora Birthday Gift. ||||||||
